...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $this->Url->build('/', TRUE); ?>assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo $this->Url->build('/', TRUE); ?>assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo $this->Url->build('/', TRUE); ?>assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?php echo $this->Url->build('/', TRUE); ?>assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="<?php echo $this->Url->build('/', TRUE); ?>assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="<?php echo $this->Url->build('/', TRUE); ?>assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="<?php echo $this->Url->build('/', TRUE); ?>assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?php echo $this->Url->build('/', TRUE); ?>assets/pages/scripts/login.min.js" type="text/javascript"></script>
